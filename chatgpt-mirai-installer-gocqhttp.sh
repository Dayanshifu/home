...
DOCKER_COMPOSE_URL=https://mirror.ghproxy.com/https://github.com/docker/compose/releases/download/v2.14.0/docker-compose-`uname -s`-`uname -m`
...
echo -e "${YELLOW}https://mirror.ghproxy.com/https://github.com/lss233/chatgpt-mirai-qq-bot/issues/85${PLAIN}"
